...
def main():
    ...
    parser.add_argument("--output", type=str, default="evaluation_results-gpt5.json", help="Output JSON file path")
    parser.add_argument("--api-key", type=str, help="OpenAI API key (or set OPENAI_API_KEY env var)")
    parser.add_argument("--max-concurrent", type=int, default=16, help="Maximum concurrent article processing (default: 50)")
