...
def main():
    ...
    parser.add_argument("--api-key", type=str, required=True, help="OpenRouter API key (or set OPENROUTER_API_KEY env var)")
    parser.add_argument("--max-concurrent", type=int, default=32, help="Maximum concurrent article processing (default: 32)")
